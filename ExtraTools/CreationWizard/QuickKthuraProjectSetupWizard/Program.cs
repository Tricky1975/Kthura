...
namespace QuickKthuraProjectSetupWizard
{
    class MainClass
    {
        ...
        static VBox MainBox;
        readonly static Dictionary<string, TextView> Fields = new Dictionary<string, TextView>();
        readonly static Dictionary<string, Button> Browse = new Dictionary<string, Button>();
        readonly static Dictionary<Button, string> Browse2Source = new Dictionary<Button, string>();
        ...
        public static void Main(string[] args)
        {
            ...
            InitMainBox();
            if (args.Length == 0) { Fields["*KTHURA"].Buffer.Text = AppDomain.CurrentDomain.BaseDirectory; } else { Fields["*KTHURA"].Buffer.Text = args[0]; }
            win.ShowAll();
            Application.Run();
        }
    }
