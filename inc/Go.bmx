...
Version: 15.10.12
End Rem
MKL_Version "Kthura Map System - Go.bmx","15.10.12"
...
If oldconsoletext<>TextFieldText(PConsole)
	...
	EndIf
layerselector.setenabled kthmap.multi<>Null
layerremove.setenabled   kthmap.multi And CountGadgetItems(layerselector)>1	
GetEvent
